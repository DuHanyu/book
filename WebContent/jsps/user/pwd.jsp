...
<html>
  ...
  <body>
	...
	<div class="div1">
		<form action="updatePassword" method="post" target="_top">
		...
		<table>
			...
			<tr>
				...
				<td><label id="loginpassError" class="error">${loginpass }</label></td>
			</tr>
			<tr>
				<td align="right">新密码:</td>
				<td><input class="input" type="password" name="newpass" id="newpass" value=""/></td>
				<td><label id="newpassError" class="error">${newpass }</label></td>
			</tr>
			<tr>
				<td align="right">确认密码:</td>
				<td><input class="input" type="password" name="reloginpass" id="reloginpass" value=""/></td>
				<td><label id="reloginpassError" class="error">${reloginpass }</label></td>
			</tr>
			<tr>
				<td align="right"></td>
				<td>
				  <img id="imgVerifyCode" src="<c:url value='/verifyCode'/>" border="1"/>
			...
			<tr>
				...
				<td><label id="verifyCodeError" class="error">${verifyCode}</label></td>
			</tr>
			<tr>
				<td align="right"></td>
