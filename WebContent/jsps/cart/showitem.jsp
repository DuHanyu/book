...
/* 	function to(){
		...
		location="/book2/createOrder?cartItemIds="+cartItemIds+"&address="+address;
	} */
  ...
  <body>
<form id="form1" action="<c:url value='/aa'/>" method="post">
	 <input  type="hidden" name="ids" value="${requestScope.cartItemIds }"/> 
...
<c:forEach items="${requestScope.cartItemList }" var="cartItem">
	...
	<tr>
		<td style="border-top-width: 4px;" colspan="5" align="right">
			...
			<!-- <a id="linkSubmit" href="javascript:to();">提交订单</a>  -->
		</td>
	</tr>
</table>
</form>
